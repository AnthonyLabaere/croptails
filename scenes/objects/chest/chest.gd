...
var corn_harvest_scene = preload("res://scenes/objects/corn_harvest.tscn")
var tomato_harvest_scene = preload("res://scenes/objects/tomato.tscn")
...
func on_feed_the_animals() -> void: 
	if in_range:
		trigged_feed_harvest("corn", corn_harvest_scene)
		trigged_feed_harvest("tomato", tomato_harvest_scene)


func trigged_feed_harvest(inventory_item: String, scene: Resource) -> void: 
...
func on_food_received(area2D: Area2D) -> void:
